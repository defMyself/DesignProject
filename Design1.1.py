...
class MyApp(QMainWindow):
    ...
    def ip_scan(self):
        print("start ip scan : {}".format(self.ip_scan_input.text()))

    def domain_enum(self):
        print("start domain enum : {}".format(self.domain_enum_input.text()))

    def finger_print_scan(self):
        print("start finger print scan : {}".format(self.finger_print_input.text()))
